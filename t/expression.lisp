...
(llvm:with-objects ((*module* llvm:module "<unknown>")
  ...
  (prove:is (satori:evlis '((let ((x (if (eq 0 1)
                                         1
                                         0)))
                              x))) 0)

  ;; An `if' expression used as the basis for a definition.
  (prove:is (satori:evlis '((define x
                             (if (eq 0 1)
                                 1
                                 0))
                            x)) 0)
  ...
  (prove:is (satori:evlis '((let ((factorial
                                    (lambda (x)
                                      (if (eq x 1)
                                          1
                                          (mul x (factorial (sub x 1)))))))
